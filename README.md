...
- [zhengchenliang/cursor-clean](https://github.com/zhengchenliang/cursor-clean) - Maintenance toolkit for Cursor IDE — diagnose, configure, clean, and repair state.vscdb bloat (2 days ago)
