...
- [shurco/goXero](https://github.com/shurco/goXero) - 🏦 goXero is an open accounting backend inspired by Xero and designed for developers who need control over their accounting workflows instead of depending on a hosted SaaS product. (2 months ago)
...
- [🐛 fix(products): show active products on public storefront](https://github.com/shurco/mycart/pull/331) on [shurco/mycart](https://github.com/shurco/mycart) (1 week ago)
- [🐛 fix(products): allow free products with zero amount](https://github.com/shurco/mycart/pull/330) on [shurco/mycart](https://github.com/shurco/mycart) (1 week ago)
- [✨ feat(install): add CLI install command and install status API](https://github.com/shurco/mycart/pull/329) on [shurco/mycart](https://github.com/shurco/mycart) (1 week ago)
...
- [erincatto/box3d](https://github.com/erincatto/box3d) - Box3D is a 3D physics engine for games (2 days ago)
- [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus) - No fortress, purely open ground.  OpenManus is Coming. (3 days ago)
