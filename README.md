...
- [chaisql/chai](https://github.com/chaisql/chai) - Modern embedded SQL database (today)
- [webp-sh/webp_server_go](https://github.com/webp-sh/webp_server_go) - Go version of WebP Server. A tool that will serve your JPG/PNG/BMP/SVGs as WebP/AVIF format with compression, on-the-fly. (3 days ago)
